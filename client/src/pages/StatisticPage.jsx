...
export const StatisticPage = () => {
    ...
    <h1 className="text-4xl font-bold text-center mb-4">İstatistiklerim</h1>
    {
      ...
      <div className='statistic-section'>
          <h2 className='text-lg'>
              Hoşgeldin <span className='text-green-700 font bold text-xl'>{user.username}</span>
          </h2>
          <div className="statistic-cards grid xl:grid-cols-4 md:grid-cols-2 md:gap-10 gap-4 my-10">
  ...
  </div>):<Spin size="large" className="absolute flex justify-center top-1/2 w-screen h-screen "/>
    }
    </>
  )
}
